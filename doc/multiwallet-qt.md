...
Only requiring some minor changes is bitnodes.cpp.
...
Changes to bitnodes.cpp
----------------------
bitnodes.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
