...
Only requiring some minor changes is bitnodespro.cpp.
...
Changes to bitnodespro.cpp
----------------------
bitnodespro.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
